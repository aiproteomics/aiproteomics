...
def build_prosit1_model():  # pylint: disable=too-many-locals
    ...
    encoder1 = layers.Bidirectional(
        encoder1_gru, name='encoder1', merge_mode='concat', trainable=True)(embedding)

    dropout_1 = layers.Dropout(
        name='dropout_1', rate=0.3, noise_shape=None, seed=None, trainable=True)(encoder1)
    ...
    dropout_2 = layers.Dropout(
        name='dropout_2', rate=0.3, noise_shape=None, seed=None, trainable=True)(encoder2)
    ...
    # Joining branches
    add_meta = layers.Multiply(name='add_meta', trainable=True)([
        encoder_att, meta_dense_do])
