...
For plotting the model graphs in the demo notebook we need to install the Graphviz software. For general information on installing Grpahviz see the [graphviz download information](https://graphviz.gitlab.io/download/), for ubuntu/debian based systems use:
```
...
```
For more elaborate development instructions see `./README.dev.md`.
